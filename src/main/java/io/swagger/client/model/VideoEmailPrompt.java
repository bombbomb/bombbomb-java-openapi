...
public class VideoEmailPrompt   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The subject line of the final email")
   ...
   * @return emailContent
  **/
  @ApiModelProperty(example = "null", value = "The HTML content of the final email")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The id for the alternate content id")
  ...
  **/
  ...
  public VideoEmailPrompt sendMechanism(DateTime sendMechanism) {
