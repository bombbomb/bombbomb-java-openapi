...
public class VideoEmailPrompt   {
  ...
  **/
  ...
  public VideoEmailPrompt toEmailAddresses(List<String> toEmailAddresses) {
    this.toEmailAddresses = toEmailAddresses;
    return this;
  }

  public VideoEmailPrompt addToEmailAddressesItem(String toEmailAddressesItem) {
    this.toEmailAddresses.add(toEmailAddressesItem);
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "Email addresses to send the final email to, can be mixed with listIds.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, videoEmailPrompt.id) &&
        ...
        Objects.equals(this.toEmailAddresses, videoEmailPrompt.toEmailAddresses) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, templateId, emailSubjectLine, emailContent, thumbnailUrl, toEmailAddresses, toLists, jerichoId, promptSubject, promptHtml, promptIntro, exampleVideoId, sendWithoutVideo, videoDueDate, scheduledSendDate, videoId, emailId, jobId, promptBotId, clientGroupId, status, applyTemplate, createdDate, lastNotified);
  }
  ...
  public String toString() {
    ...
    sb.append("    toEmailAddresses: ").append(toIndentedString(toEmailAddresses)).append("\n");
