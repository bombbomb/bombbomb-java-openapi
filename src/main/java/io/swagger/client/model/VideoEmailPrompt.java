...
public class VideoEmailPrompt   {
  ...
  private String sendMechanism = null;

  @SerializedName("hasSocial")
  private Boolean hasSocial = null;
  ...
  **/
  @ApiModelProperty(example = "null", value = "The facebook message to be passed off to social sender")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The twitter message to be passed off to social sender")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The linkedin message to be passed off to social sender")
  ...
  public VideoEmailPrompt sendMechanism(String sendMechanism) {
  ...
  **/
  ...
  public String getSendMechanism() {
    return sendMechanism;
  }

  public void setSendMechanism(String sendMechanism) {
    this.sendMechanism = sendMechanism;
  }

  public VideoEmailPrompt hasSocial(Boolean hasSocial) {
   ...
   * @return hasSocial
  **/
  @ApiModelProperty(example = "null", value = "this determines whether or not it has a social content.")
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    hasSocial: ").append(toIndentedString(hasSocial)).append("\n");
