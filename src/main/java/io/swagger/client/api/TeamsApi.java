...
public class TeamsApi {
    ...
    private com.squareup.okhttp.Call getTeamPromptCampaignsCall(String clientGroupId, String searchTerm, String orderBy, String asc, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @param orderBy How to sort the column (optional)
     * @param asc Ascending or not (optional)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void getTeamPromptCampaigns(String clientGroupId, String searchTerm, String orderBy, String asc) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getTeamPromptCampaignsWithHttpInfo(String clientGroupId, String searchTerm, String orderBy, String asc) throws ApiException {
        com.squareup.okhttp.Call call = getTeamPromptCampaignsCall(clientGroupId, searchTerm, orderBy, asc, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getTeamPromptCampaignsAsync(String clientGroupId, String searchTerm, String orderBy, String asc, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTeamPromptCampaignsCall(clientGroupId, searchTerm, orderBy, asc, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call updateTeamCall(String teamId, String name, String state, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TeamPublicRepresentation updateTeam(String teamId, String name, String state) throws ApiException {
        ApiResponse<TeamPublicRepresentation> resp = updateTeamWithHttpInfo(teamId, name, state);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TeamPublicRepresentation> updateTeamWithHttpInfo(String teamId, String name, String state) throws ApiException {
        com.squareup.okhttp.Call call = updateTeamCall(teamId, name, state, null, null);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateTeamAsync(String teamId, String name, String state, final ApiCallback<TeamPublicRepresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTeamCall(teamId, name, state, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for updateTeamMember */
    private com.squareup.okhttp.Call updateTeamMemberCall(String teamId, String userId, Boolean admin, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateTeamMember(String teamId, String userId, Boolean admin) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateTeamMemberWithHttpInfo(String teamId, String userId, Boolean admin) throws ApiException {
        com.squareup.okhttp.Call call = updateTeamMemberCall(teamId, userId, admin, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateTeamMemberAsync(String teamId, String userId, Boolean admin, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTeamMemberCall(teamId, userId, admin, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
