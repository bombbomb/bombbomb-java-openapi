...
public class TeamsApi {
     ...
     */
    public com.squareup.okhttp.Call addTeamMemberCall(String teamId, Boolean admin, String subgroupIds, String userEmail, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/member"
    ...
    private com.squareup.okhttp.Call addTeamMemberValidateBeforeCall(String teamId, Boolean admin, String subgroupIds, String userEmail, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<String> addTeamMemberWithHttpInfo(String teamId, Boolean admin, String subgroupIds, String userEmail, String userId) throws ApiException {
        com.squareup.okhttp.Call call = addTeamMemberValidateBeforeCall(teamId, admin, subgroupIds, userEmail, userId, null, null);
    ...
    public com.squareup.okhttp.Call addTeamMemberAsync(String teamId, Boolean admin, String subgroupIds, String userEmail, String userId, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addTeamMemberValidateBeforeCall(teamId, admin, subgroupIds, userEmail, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addUsersCall(String teamId, String userDetails, String sendWelcomeEmail, String subgroupIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/members"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addUsersValidateBeforeCall(String teamId, String userDetails, String sendWelcomeEmail, String subgroupIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> addUsersWithHttpInfo(String teamId, String userDetails, String sendWelcomeEmail, String subgroupIds) throws ApiException {
        com.squareup.okhttp.Call call = addUsersValidateBeforeCall(teamId, userDetails, sendWelcomeEmail, subgroupIds, null, null);
    ...
    public com.squareup.okhttp.Call addUsersAsync(String teamId, String userDetails, String sendWelcomeEmail, String subgroupIds, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addUsersValidateBeforeCall(teamId, userDetails, sendWelcomeEmail, subgroupIds, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addUsersFromCsvCall(String teamId, String csvImportId, String map, String sendWelcomeEmail, String subgroupIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/members/csv"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addUsersFromCsvValidateBeforeCall(String teamId, String csvImportId, String map, String sendWelcomeEmail, String subgroupIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> addUsersFromCsvWithHttpInfo(String teamId, String csvImportId, String map, String sendWelcomeEmail, String subgroupIds) throws ApiException {
        com.squareup.okhttp.Call call = addUsersFromCsvValidateBeforeCall(teamId, csvImportId, map, sendWelcomeEmail, subgroupIds, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call addUsersFromCsvAsync(String teamId, String csvImportId, String map, String sendWelcomeEmail, String subgroupIds, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addUsersFromCsvValidateBeforeCall(teamId, csvImportId, map, sendWelcomeEmail, subgroupIds, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call cancelJerichoSendCall(String jerichoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/jericho/{jerichoId}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cancelJerichoSendValidateBeforeCall(String jerichoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> cancelJerichoSendWithHttpInfo(String jerichoId) throws ApiException {
        com.squareup.okhttp.Call call = cancelJerichoSendValidateBeforeCall(jerichoId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call cancelJerichoSendAsync(String jerichoId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cancelJerichoSendValidateBeforeCall(jerichoId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createSubteamCall(String teamId, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/subteam"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createSubteamValidateBeforeCall(String teamId, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<TeamPublicRepresentation> createSubteamWithHttpInfo(String teamId, String name) throws ApiException {
        com.squareup.okhttp.Call call = createSubteamValidateBeforeCall(teamId, name, null, null);
    ...
    public com.squareup.okhttp.Call createSubteamAsync(String teamId, String name, final ApiCallback<TeamPublicRepresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createSubteamValidateBeforeCall(teamId, name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteSubteamCall(String teamId, String subteamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteSubteamValidateBeforeCall(String teamId, String subteamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<String> deleteSubteamWithHttpInfo(String teamId, String subteamId) throws ApiException {
        com.squareup.okhttp.Call call = deleteSubteamValidateBeforeCall(teamId, subteamId, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call deleteSubteamAsync(String teamId, String subteamId, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteSubteamValidateBeforeCall(teamId, subteamId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAllClientGroupAssociationsCall(String clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/associations/";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAllClientGroupAssociationsValidateBeforeCall(String clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getAllClientGroupAssociationsWithHttpInfo(String clientId) throws ApiException {
        com.squareup.okhttp.Call call = getAllClientGroupAssociationsValidateBeforeCall(clientId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call getAllClientGroupAssociationsAsync(String clientId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllClientGroupAssociationsValidateBeforeCall(clientId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
    ...
    public com.squareup.okhttp.Call getClientGroupAssetsCall(String assetType, String teamId, String autoTagName, String pageSize, String page, String search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (autoTagName != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("autoTagName", autoTagName));
        if (pageSize != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getClientGroupAssetsValidateBeforeCall(String assetType, String teamId, String autoTagName, String pageSize, String page, String search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<InlineResponse200> getClientGroupAssetsWithHttpInfo(String assetType, String teamId, String autoTagName, String pageSize, String page, String search) throws ApiException {
        com.squareup.okhttp.Call call = getClientGroupAssetsValidateBeforeCall(assetType, teamId, autoTagName, pageSize, page, search, null, null);
    ...
    public com.squareup.okhttp.Call getClientGroupAssetsAsync(String assetType, String teamId, String autoTagName, String pageSize, String page, String search, final ApiCallback<InlineResponse200> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getClientGroupAssetsValidateBeforeCall(assetType, teamId, autoTagName, pageSize, page, search, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getClientGroupStatisticsCall(String teamId, String memberStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/stats"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (memberStatus != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("memberStatus", memberStatus));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getClientGroupStatisticsValidateBeforeCall(String teamId, String memberStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getClientGroupStatisticsWithHttpInfo(String teamId, String memberStatus) throws ApiException {
        com.squareup.okhttp.Call call = getClientGroupStatisticsValidateBeforeCall(teamId, memberStatus, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call getClientGroupStatisticsAsync(String teamId, String memberStatus, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getClientGroupStatisticsValidateBeforeCall(teamId, memberStatus, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getJerichoSendsCall(String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/jericho"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getJerichoSendsValidateBeforeCall(String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<JerichoConfiguration>> getJerichoSendsWithHttpInfo(String teamId) throws ApiException {
        com.squareup.okhttp.Call call = getJerichoSendsValidateBeforeCall(teamId, null, null);
    ...
    public com.squareup.okhttp.Call getJerichoSendsAsync(String teamId, final ApiCallback<List<JerichoConfiguration>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getJerichoSendsValidateBeforeCall(teamId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<JerichoConfiguration>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getJerichoStatsCall(String jerichoId, String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/jericho/{jerichoId}/performance"
            .replaceAll("\\{" + "jerichoId" + "\\}", apiClient.escapeString(jerichoId.toString()))
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getJerichoStatsValidateBeforeCall(String jerichoId, String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<JerichoPerformance> getJerichoStatsWithHttpInfo(String jerichoId, String teamId) throws ApiException {
        com.squareup.okhttp.Call call = getJerichoStatsValidateBeforeCall(jerichoId, teamId, null, null);
    ...
    public com.squareup.okhttp.Call getJerichoStatsAsync(String jerichoId, String teamId, final ApiCallback<JerichoPerformance> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getJerichoStatsValidateBeforeCall(jerichoId, teamId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<JerichoPerformance>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPagedClientGroupMembersValidateBeforeCall(String teamId, String pageSize, String page, String status, String search, String orderBy, String orderDirection, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getPagedClientGroupMembersWithHttpInfo(String teamId, String pageSize, String page, String status, String search, String orderBy, String orderDirection) throws ApiException {
        com.squareup.okhttp.Call call = getPagedClientGroupMembersValidateBeforeCall(teamId, pageSize, page, status, search, orderBy, orderDirection, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call getPagedClientGroupMembersAsync(String teamId, String pageSize, String page, String status, String search, String orderBy, String orderDirection, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPagedClientGroupMembersValidateBeforeCall(teamId, pageSize, page, status, search, orderBy, orderDirection, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for getPromptMonthlyStats
     * @param month The month whose Jericho sends you wish to see. (required)
     * @param year The year whose Jericho sends you wish to see. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPromptMonthlyStatsCall(String month, String year, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{month}/{year}/monthStats"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPromptMonthlyStatsValidateBeforeCall(String month, String year, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'month' is set
        if (month == null) {
            throw new ApiException("Missing the required parameter 'month' when calling getPromptMonthlyStats(Async)");
        }
        
        // verify the required parameter 'year' is set
        if (year == null) {
            throw new ApiException("Missing the required parameter 'year' when calling getPromptMonthlyStats(Async)");
        }
        

        com.squareup.okhttp.Call call = getPromptMonthlyStatsCall(month, year, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String getPromptMonthlyStats(String month, String year) throws ApiException {
        ApiResponse<String> resp = getPromptMonthlyStatsWithHttpInfo(month, year);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getPromptMonthlyStatsWithHttpInfo(String month, String year) throws ApiException {
        com.squareup.okhttp.Call call = getPromptMonthlyStatsValidateBeforeCall(month, year, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Jericho Monthly Stats (asynchronously)
     * Jericho Monthly Stats
     * @param month The month whose Jericho sends you wish to see. (required)
     * @param year The year whose Jericho sends you wish to see. (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPromptMonthlyStatsAsync(String month, String year, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPromptMonthlyStatsValidateBeforeCall(month, year, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getPromptOverview
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPromptOverviewCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/promptOverview";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPromptOverviewValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getPromptOverviewCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String getPromptOverview() throws ApiException {
        ApiResponse<String> resp = getPromptOverviewWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getPromptOverviewWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getPromptOverviewValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Prompt Overview (asynchronously)
     * Get Prompt Overview
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPromptOverviewAsync(final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPromptOverviewValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSubteamsCall(String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSubteamsValidateBeforeCall(String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<TeamPublicRepresentation>> getSubteamsWithHttpInfo(String teamId) throws ApiException {
        com.squareup.okhttp.Call call = getSubteamsValidateBeforeCall(teamId, null, null);
    ...
    public com.squareup.okhttp.Call getSubteamsAsync(String teamId, final ApiCallback<List<TeamPublicRepresentation>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSubteamsValidateBeforeCall(teamId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<TeamPublicRepresentation>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getTeamPromptAggregateStatsCall(String clientGroupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{clientGroupId}/campaign/stats"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTeamPromptAggregateStatsValidateBeforeCall(String clientGroupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getTeamPromptAggregateStatsWithHttpInfo(String clientGroupId) throws ApiException {
        com.squareup.okhttp.Call call = getTeamPromptAggregateStatsValidateBeforeCall(clientGroupId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call getTeamPromptAggregateStatsAsync(String clientGroupId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTeamPromptAggregateStatsValidateBeforeCall(clientGroupId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getTeamPromptCampaignsCall(String clientGroupId, String searchTerm, String currentPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{clientGroupId}/campaign"
            .replaceAll("\\{" + "clientGroupId" + "\\}", apiClient.escapeString(clientGroupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTeamPromptCampaignsValidateBeforeCall(String clientGroupId, String searchTerm, String currentPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> getTeamPromptCampaignsWithHttpInfo(String clientGroupId, String searchTerm, String currentPage) throws ApiException {
        com.squareup.okhttp.Call call = getTeamPromptCampaignsValidateBeforeCall(clientGroupId, searchTerm, currentPage, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call getTeamPromptCampaignsAsync(String clientGroupId, String searchTerm, String currentPage, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTeamPromptCampaignsValidateBeforeCall(clientGroupId, searchTerm, currentPage, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call inviteToSocialPromptTeamCall(String teamId, String listId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/teams/prompt/invite";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call inviteToSocialPromptTeamValidateBeforeCall(String teamId, String listId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> inviteToSocialPromptTeamWithHttpInfo(String teamId, String listId) throws ApiException {
        com.squareup.okhttp.Call call = inviteToSocialPromptTeamValidateBeforeCall(teamId, listId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call inviteToSocialPromptTeamAsync(String teamId, String listId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = inviteToSocialPromptTeamValidateBeforeCall(teamId, listId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call queueJerichoSendCall(JerichoConfiguration config, String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call queueJerichoSendValidateBeforeCall(JerichoConfiguration config, String teamId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<JerichoConfiguration> queueJerichoSendWithHttpInfo(JerichoConfiguration config, String teamId) throws ApiException {
        com.squareup.okhttp.Call call = queueJerichoSendValidateBeforeCall(config, teamId, null, null);
    ...
    public com.squareup.okhttp.Call queueJerichoSendAsync(JerichoConfiguration config, String teamId, final ApiCallback<JerichoConfiguration> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = queueJerichoSendValidateBeforeCall(config, teamId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<JerichoConfiguration>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call removeMemberFromTeamCall(String teamId, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/member/{userId}"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call removeMemberFromTeamValidateBeforeCall(String teamId, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<String> removeMemberFromTeamWithHttpInfo(String teamId, String userId) throws ApiException {
        com.squareup.okhttp.Call call = removeMemberFromTeamValidateBeforeCall(teamId, userId, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call removeMemberFromTeamAsync(String teamId, String userId, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = removeMemberFromTeamValidateBeforeCall(teamId, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call resendTeamMemberInvitationCall(String teamId, String memberUserId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}/{memberUserId}/rewelcome"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call resendTeamMemberInvitationValidateBeforeCall(String teamId, String memberUserId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<TeamPublicRepresentation> resendTeamMemberInvitationWithHttpInfo(String teamId, String memberUserId) throws ApiException {
        com.squareup.okhttp.Call call = resendTeamMemberInvitationValidateBeforeCall(teamId, memberUserId, null, null);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call resendTeamMemberInvitationAsync(String teamId, String memberUserId, final ApiCallback<TeamPublicRepresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = resendTeamMemberInvitationValidateBeforeCall(teamId, memberUserId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateJerichoPromptSendCall(String teamId, String jerichoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateJerichoPromptSendValidateBeforeCall(String teamId, String jerichoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateJerichoPromptSendWithHttpInfo(String teamId, String jerichoId) throws ApiException {
        com.squareup.okhttp.Call call = updateJerichoPromptSendValidateBeforeCall(teamId, jerichoId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call updateJerichoPromptSendAsync(String teamId, String jerichoId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateJerichoPromptSendValidateBeforeCall(teamId, jerichoId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateTeamCall(String teamId, String name, String state, Boolean subteamsCanAddMembers, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/team/{teamId}"
            .replaceAll("\\{" + "teamId" + "\\}", apiClient.escapeString(teamId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateTeamValidateBeforeCall(String teamId, String name, String state, Boolean subteamsCanAddMembers, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<TeamPublicRepresentation> updateTeamWithHttpInfo(String teamId, String name, String state, Boolean subteamsCanAddMembers) throws ApiException {
        com.squareup.okhttp.Call call = updateTeamValidateBeforeCall(teamId, name, state, subteamsCanAddMembers, null, null);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call updateTeamAsync(String teamId, String name, String state, Boolean subteamsCanAddMembers, final ApiCallback<TeamPublicRepresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTeamValidateBeforeCall(teamId, name, state, subteamsCanAddMembers, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TeamPublicRepresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateTeamMemberCall(String teamId, String userId, Boolean admin, String permissionSuiteId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateTeamMemberValidateBeforeCall(String teamId, String userId, Boolean admin, String permissionSuiteId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateTeamMemberWithHttpInfo(String teamId, String userId, Boolean admin, String permissionSuiteId) throws ApiException {
        com.squareup.okhttp.Call call = updateTeamMemberValidateBeforeCall(teamId, userId, admin, permissionSuiteId, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call updateTeamMemberAsync(String teamId, String userId, Boolean admin, String permissionSuiteId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTeamMemberValidateBeforeCall(teamId, userId, admin, permissionSuiteId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
