...
public class VideosApi {
     ...
     */
    public com.squareup.okhttp.Call getVideoEncodingStatusCall(String videoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getVideoEncodingStatusValidateBeforeCall(String videoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<VideoEncodingStatusResponse> getVideoEncodingStatusWithHttpInfo(String videoId) throws ApiException {
        com.squareup.okhttp.Call call = getVideoEncodingStatusValidateBeforeCall(videoId, null, null);
    ...
    public com.squareup.okhttp.Call getVideoEncodingStatusAsync(String videoId, final ApiCallback<VideoEncodingStatusResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getVideoEncodingStatusValidateBeforeCall(videoId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VideoEncodingStatusResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getVideoRecorderCall(Integer width, String videoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/videos/live/getRecorder";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getVideoRecorderValidateBeforeCall(Integer width, String videoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<VideoRecorderMethodResponse> getVideoRecorderWithHttpInfo(Integer width, String videoId) throws ApiException {
        com.squareup.okhttp.Call call = getVideoRecorderValidateBeforeCall(width, videoId, null, null);
    ...
    public com.squareup.okhttp.Call getVideoRecorderAsync(Integer width, String videoId, final ApiCallback<VideoRecorderMethodResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getVideoRecorderValidateBeforeCall(width, videoId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VideoRecorderMethodResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call markLiveRecordingCompleteCall(String videoId, String filename, String title, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/videos/live/markComplete";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call markLiveRecordingCompleteValidateBeforeCall(String videoId, String filename, String title, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<VideoPublicRepresentation> markLiveRecordingCompleteWithHttpInfo(String videoId, String filename, String title) throws ApiException {
        com.squareup.okhttp.Call call = markLiveRecordingCompleteValidateBeforeCall(videoId, filename, title, null, null);
    ...
    public com.squareup.okhttp.Call markLiveRecordingCompleteAsync(String videoId, String filename, String title, final ApiCallback<VideoPublicRepresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = markLiveRecordingCompleteValidateBeforeCall(videoId, filename, title, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VideoPublicRepresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call signUploadCall(SignUploadRequest policy, Boolean v4, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = policy;

        // create path and map variables
        String localVarPath = "/video/signedUpload";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call signUploadValidateBeforeCall(SignUploadRequest policy, Boolean v4, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<String> signUploadWithHttpInfo(SignUploadRequest policy, Boolean v4) throws ApiException {
        com.squareup.okhttp.Call call = signUploadValidateBeforeCall(policy, v4, null, null);
    ...
    public com.squareup.okhttp.Call signUploadAsync(SignUploadRequest policy, Boolean v4, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = signUploadValidateBeforeCall(policy, v4, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateVideoThumbnailV2Call(String videoId, String thumbnail, Boolean custom, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/videos/thumbnail";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateVideoThumbnailV2ValidateBeforeCall(String videoId, String thumbnail, Boolean custom, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateVideoThumbnailV2WithHttpInfo(String videoId, String thumbnail, Boolean custom) throws ApiException {
        com.squareup.okhttp.Call call = updateVideoThumbnailV2ValidateBeforeCall(videoId, thumbnail, custom, null, null);
    ...
    public com.squareup.okhttp.Call updateVideoThumbnailV2Async(String videoId, String thumbnail, Boolean custom, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateVideoThumbnailV2ValidateBeforeCall(videoId, thumbnail, custom, progressListener, progressRequestListener);
