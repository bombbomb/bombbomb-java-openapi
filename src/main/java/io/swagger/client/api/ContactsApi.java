...
public class ContactsApi {
    ...
    private com.squareup.okhttp.Call deleteContactsCall(String listId, String contactIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<Void> deleteContactsWithHttpInfo(String listId, String contactIds) throws ApiException {
        com.squareup.okhttp.Call call = deleteContactsCall(listId, contactIds, null, null);
        return apiClient.execute(call);
    }
