...
public class PromptsApi {
    ...
    private com.squareup.okhttp.Call getAlternateCampaignContentCall(String clientGroupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/campaign/{campaignId}/content/alternate".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Void> getAlternateCampaignContentWithHttpInfo(String clientGroupId) throws ApiException {
        com.squareup.okhttp.Call call = getAlternateCampaignContentCall(clientGroupId, null, null);
    ...
    private com.squareup.okhttp.Call getPromptCampaignsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/prompts/{userId}/campaigns".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call syncPromptSubscriptionsCall(Boolean migrate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/prompts/campaigns/sync".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Void> syncPromptSubscriptionsWithHttpInfo(Boolean migrate) throws ApiException {
        com.squareup.okhttp.Call call = syncPromptSubscriptionsCall(migrate, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updatePromptWithHttpInfo(String id, String sendMechanism, String facebookMessage, String twitterMessage, String videoId, String emailId, String subject, String resetCache, String resetEmailContent, String status) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptCall(id, sendMechanism, facebookMessage, twitterMessage, videoId, emailId, subject, resetCache, resetEmailContent, status, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call updatePromptTemplateCall(String id, String alternateContentId, String newEmailId, String ogEmailId, String newExampleVideoId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/prompts/{id}/content".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    public ApiResponse<Void> updatePromptTemplateWithHttpInfo(String id, String alternateContentId, String newEmailId, String ogEmailId, String newExampleVideoId) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptTemplateCall(id, alternateContentId, newEmailId, ogEmailId, newExampleVideoId, null, null);
        return apiClient.execute(call);
    }
