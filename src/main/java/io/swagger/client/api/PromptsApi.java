...
public class PromptsApi {
    ...
    private com.squareup.okhttp.Call createPromptBotCall(String listId, String emailId, String endDate, String promptSubject, String promptBody, String botTypeId, String templateId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'listId' is set
        if (listId == null) {
            throw new ApiException("Missing the required parameter 'listId' when calling createPromptBot(Async)");
        }
        ...
        if (endDate == null) {
            throw new ApiException("Missing the required parameter 'endDate' when calling createPromptBot(Async)");
        }
        
        // verify the required parameter 'promptSubject' is set
        if (promptSubject == null) {
            throw new ApiException("Missing the required parameter 'promptSubject' when calling createPromptBot(Async)");
        }
        
        // verify the required parameter 'promptBody' is set
        if (promptBody == null) {
            throw new ApiException("Missing the required parameter 'promptBody' when calling createPromptBot(Async)");
        }
        ...
        if (promptSubject != null)
        localVarFormParams.put("promptSubject", promptSubject);
        if (promptBody != null)
        localVarFormParams.put("promptBody", promptBody);
        if (botTypeId != null)
     ...
     * @param listId The list id to attach the bot to. (required)
     * @param emailId The default email to use. (required)
     * @param endDate The time frame to complete sending to the list. (required)
     * @param promptSubject The prompt subject. (required)
     * @param promptBody The prompt script. (required)
     ...
     */
    public PromptBotBot createPromptBot(String listId, String emailId, String endDate, String promptSubject, String promptBody, String botTypeId, String templateId) throws ApiException {
        ApiResponse<PromptBotBot> resp = createPromptBotWithHttpInfo(listId, emailId, endDate, promptSubject, promptBody, botTypeId, templateId);
        return resp.getData();
    }
     ...
     * @param botTypeId The type of bot to create. (required)
     * @param templateId The template used to create the email id. (required)
     * @return ApiResponse&lt;PromptBotBot&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PromptBotBot> createPromptBotWithHttpInfo(String listId, String emailId, String endDate, String promptSubject, String promptBody, String botTypeId, String templateId) throws ApiException {
        com.squareup.okhttp.Call call = createPromptBotCall(listId, emailId, endDate, promptSubject, promptBody, botTypeId, templateId, null, null);
        Type localVarReturnType = new TypeToken<PromptBotBot>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call createPromptBotAsync(String listId, String emailId, String endDate, String promptSubject, String promptBody, String botTypeId, String templateId, final ApiCallback<PromptBotBot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createPromptBotCall(listId, emailId, endDate, promptSubject, promptBody, botTypeId, templateId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PromptBotBot>(){}.getType();
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PromptBotBot> getPromptBots() throws ApiException {
        ApiResponse<List<PromptBotBot>> resp = getPromptBotsWithHttpInfo();
        return resp.getData();
    }
     ...
     * List Prompt Bots
     * Returns a list of all Prompt Bots for the user.
     * @return ApiResponse&lt;List&lt;PromptBotBot&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PromptBotBot>> getPromptBotsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getPromptBotsCall(null, null);
        Type localVarReturnType = new TypeToken<List<PromptBotBot>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPromptBotsAsync(final ApiCallback<List<PromptBotBot>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call respondToVideoEmailPromptCall(String id, String choice, String videoId, String emailId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @param id The id of the prompt. (required)
     * @param choice The users&#39; selection. Can be: WithVideo, WithEmail, Cancel (required)
     * @param videoId The id of the video. (optional)
     * @param emailId The id of the video. (optional)
     * @return VideoEmailPrompt
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VideoEmailPrompt respondToVideoEmailPrompt(String id, String choice, String videoId, String emailId) throws ApiException {
        ApiResponse<VideoEmailPrompt> resp = respondToVideoEmailPromptWithHttpInfo(id, choice, videoId, emailId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VideoEmailPrompt> respondToVideoEmailPromptWithHttpInfo(String id, String choice, String videoId, String emailId) throws ApiException {
        com.squareup.okhttp.Call call = respondToVideoEmailPromptCall(id, choice, videoId, emailId, null, null);
        Type localVarReturnType = new TypeToken<VideoEmailPrompt>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call respondToVideoEmailPromptAsync(String id, String choice, String videoId, String emailId, final ApiCallback<VideoEmailPrompt> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = respondToVideoEmailPromptCall(id, choice, videoId, emailId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VideoEmailPrompt>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for updatePromptBot */
    private com.squareup.okhttp.Call updatePromptBotCall(String id, String emailId, String endDate, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @param emailId The default email to use. (optional)
     * @param endDate The time frame to complete sending to the list. (optional)
     * @param status The status of the bot. (optional)
     * @return PromptBotBot
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PromptBotBot updatePromptBot(String id, String emailId, String endDate, String status) throws ApiException {
        ApiResponse<PromptBotBot> resp = updatePromptBotWithHttpInfo(id, emailId, endDate, status);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PromptBotBot> updatePromptBotWithHttpInfo(String id, String emailId, String endDate, String status) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptBotCall(id, emailId, endDate, status, null, null);
        Type localVarReturnType = new TypeToken<PromptBotBot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePromptBotAsync(String id, String emailId, String endDate, String status, final ApiCallback<PromptBotBot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePromptBotCall(id, emailId, endDate, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PromptBotBot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for updatePromptCampaign */
    private com.squareup.okhttp.Call updatePromptCampaignCall(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updatePromptCampaign(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updatePromptCampaignWithHttpInfo(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptCampaignCall(clientGroupId, brandedTemplateId, personalTemplateId, enabled, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePromptCampaignAsync(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePromptCampaignCall(clientGroupId, brandedTemplateId, personalTemplateId, enabled, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
