...
public class PromptsApi {
    ...
    private com.squareup.okhttp.Call createPromptBotCall(String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String botTypeId, String templateId, String videoId, String endDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public PromptBot createPromptBot(String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String botTypeId, String templateId, String videoId, String endDate) throws ApiException {
        ApiResponse<PromptBot> resp = createPromptBotWithHttpInfo(listId, emailId, name, subject, content, contactFieldValueColumn, botTypeId, templateId, videoId, endDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PromptBot> createPromptBotWithHttpInfo(String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String botTypeId, String templateId, String videoId, String endDate) throws ApiException {
        com.squareup.okhttp.Call call = createPromptBotCall(listId, emailId, name, subject, content, contactFieldValueColumn, botTypeId, templateId, videoId, endDate, null, null);
     ...
     */
    public com.squareup.okhttp.Call createPromptBotAsync(String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String botTypeId, String templateId, String videoId, String endDate, final ApiCallback<PromptBot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createPromptBotCall(listId, emailId, name, subject, content, contactFieldValueColumn, botTypeId, templateId, videoId, endDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PromptBot>(){}.getType();
    ...
    private com.squareup.okhttp.Call updatePromptBotCall(String id, String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String templateId, String videoId, String endDate, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'listId' is set
        if (listId == null) {
            throw new ApiException("Missing the required parameter 'listId' when calling updatePromptBot(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PromptBot updatePromptBot(String id, String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String templateId, String videoId, String endDate, String status) throws ApiException {
        ApiResponse<PromptBot> resp = updatePromptBotWithHttpInfo(id, listId, emailId, name, subject, content, contactFieldValueColumn, templateId, videoId, endDate, status);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PromptBot> updatePromptBotWithHttpInfo(String id, String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String templateId, String videoId, String endDate, String status) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptBotCall(id, listId, emailId, name, subject, content, contactFieldValueColumn, templateId, videoId, endDate, status, null, null);
        Type localVarReturnType = new TypeToken<PromptBot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePromptBotAsync(String id, String listId, String emailId, String name, String subject, String content, String contactFieldValueColumn, String templateId, String videoId, String endDate, String status, final ApiCallback<PromptBot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePromptBotCall(id, listId, emailId, name, subject, content, contactFieldValueColumn, templateId, videoId, endDate, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PromptBot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for updatePromptCampaign */
    private com.squareup.okhttp.Call updatePromptCampaignCall(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, String autoShares, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (autoShares != null)
        localVarFormParams.put("autoShares", autoShares);
     ...
     * @param autoShares These are what we are autosharing to (optional)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updatePromptCampaign(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, String autoShares) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updatePromptCampaignWithHttpInfo(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, String autoShares) throws ApiException {
        com.squareup.okhttp.Call call = updatePromptCampaignCall(clientGroupId, brandedTemplateId, personalTemplateId, enabled, autoShares, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePromptCampaignAsync(String clientGroupId, String brandedTemplateId, String personalTemplateId, Boolean enabled, String autoShares, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePromptCampaignCall(clientGroupId, brandedTemplateId, personalTemplateId, enabled, autoShares, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
