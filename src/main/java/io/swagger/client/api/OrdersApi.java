...
public class OrdersApi {
     ...
     */
    public com.squareup.okhttp.Call templateAssetDeleteCall(String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/orders/templates/images";
    ...
    private com.squareup.okhttp.Call templateAssetDeleteValidateBeforeCall(String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> templateAssetDeleteWithHttpInfo(String fileName) throws ApiException {
        com.squareup.okhttp.Call call = templateAssetDeleteValidateBeforeCall(fileName, null, null);
    ...
    public com.squareup.okhttp.Call templateAssetDeleteAsync(String fileName, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = templateAssetDeleteValidateBeforeCall(fileName, progressListener, progressRequestListener);
