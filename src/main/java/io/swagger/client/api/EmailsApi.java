...
public class EmailsApi {
    ...
    private com.squareup.okhttp.Call createPrintingPressEmailCall(String templateId, String content, Boolean replace, String videoId, String subjectLine, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (replace == null) {
            throw new ApiException("Missing the required parameter 'replace' when calling createPrintingPressEmail(Async)");
        }
        ...
        if (replace != null)
        localVarFormParams.put("replace", replace);
        if (videoId != null)
     ...
     * @param replace Set whether to replace video placeholders with video id. (required)
     ...
     */
    public void createPrintingPressEmail(String templateId, String content, Boolean replace, String videoId, String subjectLine) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> createPrintingPressEmailWithHttpInfo(String templateId, String content, Boolean replace, String videoId, String subjectLine) throws ApiException {
        com.squareup.okhttp.Call call = createPrintingPressEmailCall(templateId, content, replace, videoId, subjectLine, null, null);
     ...
     */
    public com.squareup.okhttp.Call createPrintingPressEmailAsync(String templateId, String content, Boolean replace, String videoId, String subjectLine, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createPrintingPressEmailCall(templateId, content, replace, videoId, subjectLine, progressListener, progressRequestListener);
