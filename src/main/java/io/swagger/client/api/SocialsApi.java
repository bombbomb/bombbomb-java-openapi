...
public class SocialsApi {
    ...
    private com.squareup.okhttp.Call getSocialArticlePropertiesCall(String emailId, String socialContentId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (socialContentId != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "socialContentId", socialContentId));
    ...
    public ApiResponse<Void> getSocialArticlePropertiesWithHttpInfo(String emailId, String socialContentId) throws ApiException {
        com.squareup.okhttp.Call call = getSocialArticlePropertiesCall(emailId, socialContentId, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call retrySocialSendCall(String promptId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/socials/send/retry".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Void> retrySocialSendWithHttpInfo(String promptId) throws ApiException {
        com.squareup.okhttp.Call call = retrySocialSendCall(promptId, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call sendSocialCall(String promptId, String socialType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/socials/send".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Void> sendSocialWithHttpInfo(String promptId, String socialType) throws ApiException {
        com.squareup.okhttp.Call call = sendSocialCall(promptId, socialType, null, null);
        return apiClient.execute(call);
    }
    ...
    private com.squareup.okhttp.Call updateClientGroupsSendMechanismCall(String sendMechanism, String enabled, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/socials/client/sendMechanisms".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<Void> updateClientGroupsSendMechanismWithHttpInfo(String sendMechanism, String enabled) throws ApiException {
        com.squareup.okhttp.Call call = updateClientGroupsSendMechanismCall(sendMechanism, enabled, null, null);
        return apiClient.execute(call);
    }
