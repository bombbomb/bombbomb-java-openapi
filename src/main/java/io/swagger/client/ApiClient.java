...
public class ApiClient {
    ...
    private String basePath = "https://api.bombbomb.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("BBOAuth2", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bombbomb.com/v2
